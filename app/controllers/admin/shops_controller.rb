class Admin::ShopsController < Admin::BaseController
  ...
  def shop_params
    params.require(:shop).permit(:name, :phone, :address, :info, :user_id, :avatar,:backgroundimage, :category_id, :template, :subdomain, :metakeywords, :metadescription,:pagetitle, :googleanalytics, :isactive, :latitude, :longitude)
  end
end
